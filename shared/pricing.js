...
// Carrossel tem tamanho escolhido pelo cliente; post e story sao uma peca.
export const CAROUSEL_MAX = 5
export const artCount = (format, requested) => format === 'carousel'
  ? Math.min(CAROUSEL_MAX, Math.max(1, Math.round(Number(requested) || CAROUSEL_MAX)))
  : 1
